            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="row">
                            <div class="col-sm-12 m-b-xs"><span class="text-success">Total:
                                    <strong>{{ $total }}</strong></span></div>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td data-texto="{{ $perfil->nombre }}">
                                            ...
                                            @if ($permisos['Permiso_mostrar'] == 1) 
                                                <a href="{{ route('perfiles.mostrar', $perfil->id) }}" title="Mostrar"><img
                                                        width="17px" src="{{ asset('img/iconos/mostrar.png') }}"
                                                        alt="Mostrar"></a>
                                            @endif
                                            @if ($permisos['Permiso_modificar'] == 1) 
                                                <a href="{{ route('perfiles.modificar', $perfil->id) }}"
                                            ...
                                            @if ($permisos['Permiso_Eliminar'] == 1) 
                                                @if (!$perfil->es_especial)
                                                    <a data-ruta="{{ route('perfiles.eliminar', $perfil->id) }}"
                                                        class="btn-eliminar" title="Eliminar"><img width="17px"
                                                            src="{{ asset('img/iconos/eliminar.png') }}"
                                                            alt="Eliminar"></a>
                                                @endif
                                            @endif
